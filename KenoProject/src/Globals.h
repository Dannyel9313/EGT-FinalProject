...
const int PAYTABLE_HEIGHT = PAYTABLE_BOTTOM_LEFT.y - PAYTABLE_TOP_RIGHT.y;
...
const int HITS_TEXT_X = PAYTABLE_BOTTOM_LEFT.x + PAYTABLE_LEFT_MARGIN;
const int HITS_TEXT_Y = PAYTABLE_TOP_RIGHT.y + PAYTABLE_TOP_MARGIN;
const int PAY_TEXT_WIDTH = PAYTABLE_WIDTH/2 - PAYTABLE_RIGHT_MARGIN - 20;
const int PAY_TEXT_HEIGHT = PAYTABLE_HEIGHT/11;
const int PAY_TEXT_X = PAYTABLE_BOTTOM_LEFT.x + PAYTABLE_WIDTH/2 + PAYTABLE_LEFT_MARGIN;
const int PAY_TEXT_Y = PAYTABLE_TOP_RIGHT.y + PAYTABLE_TOP_MARGIN;
...
const int LINE_RECT_X = PAYTABLE_BOTTOM_LEFT.x;
const int LINE_RECT_Y = PAYTABLE_TOP_RIGHT.y + PAYTABLE_HEIGHT/11 + 2;
const int LINE_RECT_WIDTH = PAYTABLE_WIDTH;
const int LINE_RECT_HEIGHT = PAYTABLE_HEIGHT/11;
